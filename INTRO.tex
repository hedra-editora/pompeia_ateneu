...
\hedramarkboth{caio gagliardi}{introdução}

\section*{um homem de honra}

\epigraph{Que importa a inspiração doentia se o resultado é belo? A pérola é a enfermidade de um molusco.}{Raul Pompeia}
...
Pompéia foi um homem de idéias persistentes. Florianista
...
\epigraph{Até o micróbio, que é a morte, se educa e amansa.}{Raul Pompeia}
