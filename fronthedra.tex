...
\vspace{6cm} %9.3cm
\ifdef{\organizador}{{\small {\organizador}\\\vspace*{-.5cm} (\textit{organização e prefácio})} \par}{}
...
% Resumo -------------------------------------------------------
\begingroup \footnotesize \parindent0pt \parskip 5pt \thispagestyle{empty} \vspace*{-0.2\textheight}\mbox{} \vfill
